          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-linear-to-br from-gray-50 via-white to-gray-50 p-8 pr-16 rounded-2xl shadow-xl border border-gray-200 relative">
              ...
              <div className="text-center mb-10">
                <h2 className="text-4xl md:text-5xl font-bold bg-linear-to-r from-[#CFAF5A] via-[#B38938] to-[#CFAF5A] bg-clip-text text-transparent" 
                    style={{ 
                      fontFamily: "'Poppins', sans-serif",
                      letterSpacing: '-0.02em',
                      filter: 'drop-shadow(0 4px 6px rgba(179,137,56,0.7)) drop-shadow(0 8px 12px rgba(179,137,56,0.5)) drop-shadow(0 12px 20px rgba(179,137,56,0.35)) drop-shadow(0 16px 28px rgba(179,137,56,0.25))'
                    }}>
