...
$logFile = 'C:\temp\Site_Igreja_Meta\V5_SiteIgreja\workspace\shadcn-ui\logs\deploy-20251110-042748.log'
...
Write-Log "Mensagem: test: deploy automatico para comparar logs"
...
try {
    ...
    git commit -m "test: deploy automatico para comparar logs" 2>&1 | Out-File $logFile -Append
