...
$logFile = 'C:\temp\Site_Igreja_Meta\V5_SiteIgreja\workspace\shadcn-ui\logs\deploy-20251110-050409.log'
...
Write-Log "Mensagem: test: deploy modo background"
...
try {
    ...
    $gitCommitOutput = git commit -m "test: deploy modo background" 2>&1 | Out-String
