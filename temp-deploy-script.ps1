...
$logFile = 'C:\temp\Site_Igreja_Meta\V5_SiteIgreja\workspace\shadcn-ui\logs\deploy-20251110-052501.log'
...
Write-Log "Mensagem: refactor: simplificar scripts - unificar IDs e deploy, remover redundancias"
...
try {
    ...
    $gitCommitOutput = git commit -m "refactor: simplificar scripts - unificar IDs e deploy, remover redundancias" 2>&1 | Out-String
